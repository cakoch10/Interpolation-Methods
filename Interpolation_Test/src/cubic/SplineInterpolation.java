...
public class SplineInterpolation {
	...
	public SplineInterpolation(int gl){//constructor consists of a single integer representing the gapLen
		gapLen = gl;
	}
	...
	public String[] interpolateTraj(){//returns ONLY a list of the interpolated points
		...
		y = latvalArray.clone();
		*/
		UnivariateInterpolator interpolator = new SplineInterpolator();//Cubic spline
